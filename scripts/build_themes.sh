...
npx token-transformer --preserveRawValue $STYLES_PATH/tokens.json $TOKENS_PATH/light.json global,colors,core,main,light
...
# Append light theme to main.css so both :root and .light are in one file
cat ./styles/dist/light.css >> ./styles/dist/main.css
rm ./styles/dist/light.css
