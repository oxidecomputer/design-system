...
'letter-spacing': "0.02rem",
			...
			module.exports.colorUtilities = {
				...
				'.border-x-default': {
					'border-left-color': 'var(--stroke-default)','border-right-color': 'var(--stroke-default)'
				},
				'.border-x-secondary': {
					'border-left-color': 'var(--stroke-secondary)','border-right-color': 'var(--stroke-secondary)'
				},
				'.border-x-tertiary': {
					'border-left-color': 'var(--stroke-tertiary)','border-right-color': 'var(--stroke-tertiary)'
				},
				'.border-x-raise': {
					'border-left-color': 'var(--stroke-raise)','border-right-color': 'var(--stroke-raise)'
				},
				'/* Matches the default surface color */ \n.border-x-surface': {
					'border-left-color': 'var(--stroke-surface)','border-right-color': 'var(--stroke-surface)'
				},
				'.border-x-accent': {
					'border-left-color': 'var(--stroke-accent)','border-right-color': 'var(--stroke-accent)'
				},
				'.border-x-accent-secondary': {
					'border-left-color': 'var(--stroke-accent-secondary)','border-right-color': 'var(--stroke-accent-secondary)'
				},
				'.border-x-accent-tertiary': {
					'border-left-color': 'var(--stroke-accent-tertiary)','border-right-color': 'var(--stroke-accent-tertiary)'
				},
				'.border-x-destructive': {
					'border-left-color': 'var(--stroke-destructive)','border-right-color': 'var(--stroke-destructive)'
				},
				'.border-x-destructive-secondary': {
					'border-left-color': 'var(--stroke-destructive-secondary)','border-right-color': 'var(--stroke-destructive-secondary)'
				},
				'.border-x-destructive-tertiary': {
					'border-left-color': 'var(--stroke-destructive-tertiary)','border-right-color': 'var(--stroke-destructive-tertiary)'
				},
				'.border-x-success': {
					'border-left-color': 'var(--stroke-success)','border-right-color': 'var(--stroke-success)'
				},
				'.border-x-success-secondary': {
					'border-left-color': 'var(--stroke-success-secondary)','border-right-color': 'var(--stroke-success-secondary)'
				},
				'.border-x-success-tertiary': {
					'border-left-color': 'var(--stroke-success-tertiary)','border-right-color': 'var(--stroke-success-tertiary)'
				},
				'.border-x-error': {
					'border-left-color': 'var(--stroke-error)','border-right-color': 'var(--stroke-error)'
				},
				'.border-x-error-secondary': {
					'border-left-color': 'var(--stroke-error-secondary)','border-right-color': 'var(--stroke-error-secondary)'
				},
				'.border-x-error-tertiary': {
					'border-left-color': 'var(--stroke-error-tertiary)','border-right-color': 'var(--stroke-error-tertiary)'
				},
				'.border-x-notice': {
					'border-left-color': 'var(--stroke-notice)','border-right-color': 'var(--stroke-notice)'
				},
				'.border-x-notice-secondary': {
					'border-left-color': 'var(--stroke-notice-secondary)','border-right-color': 'var(--stroke-notice-secondary)'
				},
				'.border-x-notice-tertiary': {
					'border-left-color': 'var(--stroke-notice-tertiary)','border-right-color': 'var(--stroke-notice-tertiary)'
				},
				'.border-y-default': {
					'border-top-color': 'var(--stroke-default)','border-bottom-color': 'var(--stroke-default)'
				},
				'.border-y-secondary': {
					'border-top-color': 'var(--stroke-secondary)','border-bottom-color': 'var(--stroke-secondary)'
				},
				'.border-y-tertiary': {
					'border-top-color': 'var(--stroke-tertiary)','border-bottom-color': 'var(--stroke-tertiary)'
				},
				'.border-y-raise': {
					'border-top-color': 'var(--stroke-raise)','border-bottom-color': 'var(--stroke-raise)'
				},
				'/* Matches the default surface color */ \n.border-y-surface': {
					'border-top-color': 'var(--stroke-surface)','border-bottom-color': 'var(--stroke-surface)'
				},
				'.border-y-accent': {
					'border-top-color': 'var(--stroke-accent)','border-bottom-color': 'var(--stroke-accent)'
				},
				'.border-y-accent-secondary': {
					'border-top-color': 'var(--stroke-accent-secondary)','border-bottom-color': 'var(--stroke-accent-secondary)'
				},
				'.border-y-accent-tertiary': {
					'border-top-color': 'var(--stroke-accent-tertiary)','border-bottom-color': 'var(--stroke-accent-tertiary)'
				},
				'.border-y-destructive': {
					'border-top-color': 'var(--stroke-destructive)','border-bottom-color': 'var(--stroke-destructive)'
				},
				'.border-y-destructive-secondary': {
					'border-top-color': 'var(--stroke-destructive-secondary)','border-bottom-color': 'var(--stroke-destructive-secondary)'
				},
				'.border-y-destructive-tertiary': {
					'border-top-color': 'var(--stroke-destructive-tertiary)','border-bottom-color': 'var(--stroke-destructive-tertiary)'
				},
				'.border-y-success': {
					'border-top-color': 'var(--stroke-success)','border-bottom-color': 'var(--stroke-success)'
				},
				'.border-y-success-secondary': {
					'border-top-color': 'var(--stroke-success-secondary)','border-bottom-color': 'var(--stroke-success-secondary)'
				},
				'.border-y-success-tertiary': {
					'border-top-color': 'var(--stroke-success-tertiary)','border-bottom-color': 'var(--stroke-success-tertiary)'
				},
				'.border-y-error': {
					'border-top-color': 'var(--stroke-error)','border-bottom-color': 'var(--stroke-error)'
				},
				'.border-y-error-secondary': {
					'border-top-color': 'var(--stroke-error-secondary)','border-bottom-color': 'var(--stroke-error-secondary)'
				},
				'.border-y-error-tertiary': {
					'border-top-color': 'var(--stroke-error-tertiary)','border-bottom-color': 'var(--stroke-error-tertiary)'
				},
				'.border-y-notice': {
					'border-top-color': 'var(--stroke-notice)','border-bottom-color': 'var(--stroke-notice)'
				},
				'.border-y-notice-secondary': {
					'border-top-color': 'var(--stroke-notice-secondary)','border-bottom-color': 'var(--stroke-notice-secondary)'
				},
				'.border-y-notice-tertiary': {
					'border-top-color': 'var(--stroke-notice-tertiary)','border-bottom-color': 'var(--stroke-notice-tertiary)'
				},
				'.ring-default': {
			...
			module.exports.borderRadiusTokens = {
				'DEFAULT': 'var(--border-radius)','lg': 'var(--border-radius-lg)','full': 'var(--border-radius-full)'
			}
