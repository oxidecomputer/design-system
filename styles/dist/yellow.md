...
This document shows the relationship of colors within the `yellow` theme.
...
graph RL
  ...
  theme-accent-100 --> base-yellow-100
...
graph RL
  ...
  theme-accent-200 --> base-yellow-200
...
graph RL
  ...
  theme-accent-300 --> base-yellow-300
...
graph RL
  ...
  theme-accent-400 --> base-yellow-400
...
graph RL
  ...
  theme-accent-500 --> base-yellow-500
...
graph RL
  ...
  theme-accent-600 --> base-yellow-600
...
graph RL
  ...
  theme-accent-700 --> base-yellow-700
...
graph RL
  ...
  theme-accent-800 --> base-yellow-800
...
graph RL
  ...
  surface-hover --> base-neutral-300
